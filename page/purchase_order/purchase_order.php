    ...
    <div class="header">
        ...
        <form action="" method="post" id="po" style="margin:5px 10px;">
            <div style="float: right;">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#datasupplier"><i class="material-icons">add_circle_outline</i></button>
            </div>
            <div style="float: right; margin-right: 10px;">
                <input type="text" name="nama_supplier" placeholder="Pilih Supplier.." class="form-control nama_supplier" autocomplete="off" readonly required>
            </div>
            <br><br>
            ...
            <!-- <span id="adde"></span> -->
                <div class="table-responsive"> 
                    ...
                    <button type="submit" name="sall" title="Isi Semua Input Data" id="sa" class="btn btn-primary" style="margin-top: 10px;"><i class="material-icons">save</i><span>SAVE</span></button>
                </form>
            </div>
        </div>
    </div>
